...
namespace XNASysLib.XNAKernel
{
    ...
    public class SceneObject_Model : DrawableComponent, ISelectable//, IEnumerator<IDrawableComponent>, IEnumerable<IDrawableComponent>
    {
        ...
        protected OnRoll _rollOutHandler;
        protected OnRoll _rollOverHandler;
        protected float? _distOfObj;
        protected bool _lockSel;

        public bool LockSelection
        { set { _lockSel = value; } }
        public OnRoll RollOutHandler
        { get { return _rollOutHandler; } }
        public OnRoll RollOverHandler
        { get { return _rollOverHandler; } }
       ...
       // int _index;
        ...
        void OnSeletion(ISelectable obj, bool isSelected)
        {
            if (isSelected)
            {
