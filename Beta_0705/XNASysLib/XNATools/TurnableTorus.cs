...
namespace XNASysLib.XNATools
{
    ...
    /// </summary>
    public class TurnableTorus :SceneDraggablePrimitive //ToolPrimitive
    {
        ...
        public TurnableTorus(IGame game, float diameter,
        ...
        /// </summary>
        public TurnableTorus(IGame game,
                               float diameter, 
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            ShapeNode.UpdateVertice(TransformNode.World,_game.GraphicsDevice);
        ...
        {
            ShapeNode.Draw(gameTime, cam, this._basicEffect);
